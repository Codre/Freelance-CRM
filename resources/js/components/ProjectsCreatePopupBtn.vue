...
export default {
    ...
    data() {
        return {
            ...
            submittedNames: [],
            lang: {
                btn: this.translate('projects.general.index.create'),
                modal: {
                    title: this.translate('projects.general.index.create'),
                    ok: this.translate('forms.create'),
                    cancel: this.translate('forms.cancel'),
                },
                form: {
                    name: {
                        feedback: this.translate('projects.create.form.validate.name.required'),
                        label: this.translate('projects.create.form.name.label'),
                        placeholder: this.translate('projects.create.form.name.placeholder'),
                    }
                }
            }
        }

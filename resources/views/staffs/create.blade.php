...
@section('content')
    ...
    <div class="card profile">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                {!! Form::label('password_confirmation', __('staffs/create.form.password.check.label')) !!}
                {!! Form::password('password_confirmation', ['class' => 'form-control', 'placeholder' => __('staffs/create.form.password.check.placeholder')]) !!}
            </div>
        </div>
